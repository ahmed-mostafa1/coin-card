...
@section('content')
    <x-card :hover="false">
        ...
        <div class="mt-6 whitespace-pre-line text-sm leading-7 text-slate-700">
            @if(app()->getLocale() == 'ar')
                يقدم موقع market-card99.com خدماته منذ عام 2018، ويعرض حاليًا مجموعة متنوعة تشمل شحن 200 تطبيقًا ولعبة مختلفة،
            ...
            @else
                market-card99.com has been serving customers since 2018, currently offering a diverse range of top-ups for over
