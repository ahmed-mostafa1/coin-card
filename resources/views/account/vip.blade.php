    ...
    <x-card :hover="false" class="p-8">
        ...
        <div class="mt-6 grid gap-4 md:grid-cols-4">
            <div class="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-800">
                ...
                <p class="mt-2 text-xl font-bold text-emerald-700">{{ $summary['level_label'] }}</p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-800">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-800">
                ...
                <p class="mt-2 text-2xl font-bold text-emerald-700">{{ number_format($summary['discount_percentage'], 2) }}%</p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-800">
        ...
        <div class="mt-8">
            <div class="flex items-center justify-between text-sm">
                <span class="font-semibold text-slate-700 dark:text-slate-200">التقدم للخطوة التالية</span>
        ...
        <div class="mt-8 grid gap-4 md:grid-cols-3">
            <div class="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                ...
                <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">مستخدم غير موثق، بدون خصم.</p>
            </div>
