    ...
    <x-card :hover="false">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div>
                ...
                <p class="mt-2 text-sm text-slate-600">عدد الخدمات: {{ $services->count() }}</p>
            </div>
            </div>
            <form method="GET" action="{{ route('categories.show', $category->slug) }}" class="flex items-center gap-2 text-sm">
                ...
                <x-button type="submit" variant="secondary">بحث</x-button>
            </form>
        </div>
