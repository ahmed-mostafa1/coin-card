...
@section('content')
    <section class="grid gap-6 lg:grid-cols-2">
        ...
        <x-card class="bg-white text-slate-900" :hover="false">
            <h2 class="text-2xl font-semibold text-slate-900">تجربة موثوقة وسريعة</h2>
            <p class="mt-3 text-sm leading-7 text-slate-600">
                نراجع كل طلب يدويًا لضمان الدقة، مع إشعارات فورية وتحديثات واضحة لكل عميل.
            </p>
            <div class="mt-6 grid gap-3 text-sm">
                <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-700">نماذج ديناميكية حسب الخدمة</div>
                <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-700">خصم من الرصيد المتاح فقط</div>
                <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-700">سجل طلبات ودفعات واضح</div>
            </div>
        </x-card>
    </section>
