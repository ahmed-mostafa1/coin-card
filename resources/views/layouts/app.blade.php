            ...
            <nav class="border-b border-slate-200 bg-white/90 backdrop-blur">
                <div class="mx-auto flex {{ $containerWidth }} flex-row-reverse items-center justify-between px-4 py-4">
                    ...
                    <div class="flex items-center gap-3 text-sm">
                        @auth
                            <details class="relative">
                                ...
                                <div class="absolute left-0 mt-2 w-80 rounded-2xl border border-slate-200 bg-white p-4 shadow-lg">
                    ...
                    <details class="relative md:hidden">
                        <summary class="cursor-pointer rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-700">القائمة</summary>
                        <div class="absolute left-0 mt-2 w-48 rounded-xl border border-slate-200 bg-white p-2 shadow-lg">
