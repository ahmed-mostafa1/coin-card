                            ...
                            @auth
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open"
                                         ...
                                         class="absolute end-0 top-full z-50 mt-3 w-[min(22rem,calc(100vw-1rem))] overflow-hidden rounded-[1.75rem] border border-slate-50 bg-white p-4 shadow-2xl shadow-slate-900/10 dark:border-slate-700 dark:bg-slate-900 sm:w-[23rem]">
                            ...
                            @else
                                ...
                                <div class="relative" x-data="{ guestOpen: false }">
                                    ...
                                    <div x-show="guestOpen"
                                        ...
                                        <div class="mt-1 border-t border-slate-50 pt-1 dark:border-slate-800">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-2 sm:justify-end">
                        @foreach($footerSocialLinks as $social)
                            <a href="{{ $social['url'] }}"
                               ...
                               title="{{ $social['label'] }}"
                               class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-50 bg-white text-base transition dark:border-slate-700 dark:bg-slate-900 {{ $social['classes'] }}">
