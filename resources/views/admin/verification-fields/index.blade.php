            ...
            <tbody class="divide-y divide-slate-50 dark:divide-slate-700">
                @forelse ($fields as $field)
                    <tr>
                        ...
                        <td class="py-3">
                            <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-semibold {{ $field->is_enabled ? 'bg-emerald-100 text-emerald-900 dark:bg-emerald-900/30 dark:text-emerald-100' : 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300' }}">
                                {{ $field->is_enabled ? 'مفعل' : 'معطل' }}
                            </span>
                        </td>
                        <td class="py-3">
                            <div class="flex flex-wrap items-center gap-2">
                                <a href="{{ route('admin.verification-fields.edit', $field) }}" class="rounded-lg border border-emerald-200 px-2.5 py-1 text-xs font-semibold text-emerald-900 dark:border-emerald-700 dark:text-emerald-100">تعديل</a>
