                ...
                <div id="quantity-fields" class="hidden space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-text-input id="min_quantity" name="min_quantity" type="number" min="1" :value="old('min_quantity', 1)" />
                            <x-input-error :messages="$errors->get('min_quantity')" />
                        </div>
                        <div>
                            <x-input-label for="max_quantity" :value="__('messages.max_quantity')" />
                            <x-text-input id="max_quantity" name="max_quantity" type="number" min="1" :value="old('max_quantity')" />
