            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                @forelse ($currencies as $currency)
                    <tr>
                        ...
                        <td class="py-3 text-slate-500 dark:text-slate-400">{{ $currency->symbol ?: '-' }}</td>
                        ...
                        <td class="py-3"><a href="{{ route('admin.currencies.edit', $currency) }}" class="text-emerald-700 hover:text-emerald-900 dark:text-emerald-400">تعديل</a></td>
                    </tr>
                @empty
