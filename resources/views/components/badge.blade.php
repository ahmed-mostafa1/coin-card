...
@php
    $styles = [
        ...
        'approved' => 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-900 dark:text-emerald-100',
        ...
        'done' => 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-900 dark:text-emerald-100',
        'default' => 'bg-slate-50 dark:bg-slate-700 text-slate-700 dark:text-slate-50',
    ];
@endphp
