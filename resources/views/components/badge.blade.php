...
@php
    $styles = [
        ...
        'approved' => 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-900 dark:text-emerald-400',
        ...
        'done' => 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-900 dark:text-emerald-400',
