...
class ServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'service_fee_type' => ['nullable', Rule::in([Service::FEE_PERCENTAGE, Service::FEE_FIXED])],
            'service_fee_value' => ['nullable', 'numeric', 'min:0', 'decimal:0,4'],
            ...
            'seo_content_en' => ['nullable', 'string'],
            'is_topup_label_active' => ['nullable', 'boolean'],
            'topup_label_type' => ['nullable', Rule::in([Service::TOPUP_AUTOMATIC, Service::TOPUP_MANUAL])],
            'order_image_upload_enabled' => ['nullable', 'boolean'],
            'order_image_required' => ['nullable', 'boolean'],
            'order_image_help_text' => ['nullable', 'string', 'max:1000'],
            ...
            'variants.*.service_fee_type' => [Rule::prohibitedIf($isDiscountedInput), 'nullable', Rule::in([Service::FEE_PERCENTAGE, Service::FEE_FIXED])],
            'variants.*.service_fee_value' => [Rule::prohibitedIf($isDiscountedInput), 'nullable', 'numeric', 'min:0'],
